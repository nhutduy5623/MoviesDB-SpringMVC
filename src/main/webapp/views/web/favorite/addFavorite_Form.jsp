    ...
    <div class="favoriteForm-content login-content">
        ...
        <form id="form_SubmitFavorite">
           ...
           <div class="row">
            ...
            <input type="hidden" name="workCode" value="${model.code}">
            <input type="hidden" name="userCode" value="<%= SecurityUtil.getPrincipal().getCode() %>">
           <div class="row">
           	 <button id="btnSubmitFavoriteForm" type="submit">Add To Favorite</button>
           </div>
        </form>
    </div>
</div>
...
function save(data){			
	$.ajax({
        ...
        success: function (result) {
        	...
        	window.location.href = "${listURL}?code=${model.code}&message=AddFavorite_Success";
        },
