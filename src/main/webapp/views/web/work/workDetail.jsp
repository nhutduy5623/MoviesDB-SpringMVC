							...
							<div class="tab-content">
								...
								<div id="moviesrelated" class="tab">
									<div class="row">
										...
										<c:forEach var="work" items="${relatedWorkList}">
											<div class="movie-item-style-2">
												<img src="<c:url value='${work.thumbnail}'/>" alt="">
												<div class="mv-item-infor">
													<h6><a href="#">${work.name} <span>(${work.relatedDate.year + 1900 })</span></a></h6>
													<p class="rate"><i class="ion-android-star"></i><span>${model.score}</span> /10
													</p>
													<p class="describe">${work.overview}</p>
													<p class="run-time"> Run Time: 2h21’ . <span>MMPA: PG-13 </span> .
														<span>Release: ${work.relatedDate}</span></p>
